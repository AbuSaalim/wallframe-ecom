...
const ModalMediaBlock = ({media, selectedMedia, setSelectedMedia, isMultiple}) => {
    ...
    return (
        <div>
            <label 
                htmlFor={media._id} 
                className='border border-gray-200 dark:border-gray-800 relative group rounded overflow-hidden cursor-pointer block'
            >
                ...
                <div className="size-full relative pointer-events-none">
                    <Image
                        ...
                        width={300}
                        height={300}
                        className="object-center md:h-[150px] h-[100px] w-full object-cover"
                    />
                </div>
            </label>
        </div>
